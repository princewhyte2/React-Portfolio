  ...
  return (
    <StyledFooter id={"contact-me"}>
      ...
      <div className="media-icons">
        <a
          href="mailto:Princewhyte02@gmail.com"
          target="_blank"
        ...
        <a
          href="http://www.github.com/Princewhyte2"
          target="_blank"
          rel="noopener noreferrer"
          className="media-link"
        >
        ...
        <a
          href=" www.linkedin.com/in/princewhyte2"
          target="_blank"
          rel="noopener noreferrer"
          className="media-link"
        >
        ...
        <a
          href=" www.twitter.com/princewhyte02"
          target="_blank"
          rel="noopener noreferrer"
          className="media-link"
        >
      ...
      <small className="copy">
        Copyright &copy; - Princewhyte Dabotubo (CodeWithWHyte)
      </small>
    </StyledFooter>
  );
};
